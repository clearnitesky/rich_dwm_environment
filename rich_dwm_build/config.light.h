...
static const char *colors[][3]      = {
	...
	[SchemeNorm] = { col_termblu,  col_ltgrey,  col_termblu },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_ltgrey, "-nf", col_termblu, "-sb", col_ltgrey, "-sf", col_grey1, NULL };
